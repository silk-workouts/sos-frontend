          ...
          <div id="accordionGroup" className={styles.accordionGroup}>
            <section>
              ...
              <Accordion
                ...
                content="Of course. System of Silk is geared toward ALL fitness and everyone is free and encouraged to go at their own pace. We recommend trying a free* introductory workout, then discussing any thoughts or questions you may have regarding your fitness goals, with your coach."
                position="3"
              />
              <Accordion
              ...
              <Accordion
                ...
                content="Shadow Boxing is the most convenient, efficient and effective exercise for muscle tone, cardio vascular benefits and strengthening your focus. Shadow boxing improves cardio using the upper body, unlike many any other exercises. It also strengthens your legs, abs and core, so Shadow Boxing tones muscle all over your body. It enhances dexterity, improves coordination, sharpens your mind and it gives you long lean arms."
                position="10"
              />
              <Accordion
            ...
            <section>
              ...
              <Accordion
                ...
                content="Lightweight (147lbs and down): 1-3lb hand weights. Middleweight (148-175lbs): 3-5lb hand weights. Heavyweight (176lbs and up): 5-8lb hand weights. Even if you are heavyweight or middleweight, I strongly suggest you start with one pound or even no weights at all, in order for your body to adjust to the demands."
                position="13"
              />
              <Accordion
